...
public:
  UtilityTest() : file_system_(Filesystem::fileSystemForTest()) {}

  Filesystem::Instance& file_system_;
};

TEST_F(UtilityTest, convertPercentNaN) {
...
TEST_F(UtilityTest, RepeatedPtrUtilDebugString) {
...
TEST_F(UtilityTest, DowncastAndValidate) {
...
TEST_F(UtilityTest, LoadBinaryProtoFromFile) {
  envoy::config::bootstrap::v2::Bootstrap bootstrap;
...
TEST_F(UtilityTest, LoadBinaryProtoUnknownFieldFromFile) {
...
TEST_F(UtilityTest, LoadTextProtoFromFile) {
  envoy::config::bootstrap::v2::Bootstrap bootstrap;
  bootstrap.mutable_cluster_manager()
      ->mutable_upstream_bind_config()
      ->mutable_source_address()
...
TEST_F(UtilityTest, LoadTextProtoFromFile_Failure) {
  const std::string filename =
...
TEST_F(UtilityTest, KeyValueStruct) {
...
TEST_F(UtilityTest, ValueUtilEqual_NullValues) {
...
TEST_F(UtilityTest, ValueUtilEqual_StringValues) {
...
TEST_F(UtilityTest, ValueUtilEqual_NumberValues) {
  ProtobufWkt::Value v1, v2, v3;
...
TEST_F(UtilityTest, ValueUtilEqual_BoolValues) {
  ProtobufWkt::Value v1, v2, v3;
...
TEST_F(UtilityTest, ValueUtilEqual_StructValues) {
...
TEST_F(UtilityTest, ValueUtilEqual_ListValues) {
  ProtobufWkt::Value v1, v2, v3, v4;
...
TEST_F(UtilityTest, ValueUtilHash) {
  ProtobufWkt::Value v;
...
TEST_F(UtilityTest, HashedValue) {
  ProtobufWkt::Value v1, v2, v3;
  v1.set_string_value("s");
  v2.set_string_value("s");
  v3.set_string_value("not_s");
...
TEST_F(UtilityTest, HashedValueStdHash) {
  ProtobufWkt::Value v1, v2, v3;
  v1.set_string_value("s");
  v2.set_string_value("s");
  v3.set_string_value("not_s");
...
TEST_F(UtilityTest, AnyConvertWrongType) {
  ProtobufWkt::Duration source_duration;
  source_duration.set_seconds(42);
...
TEST_F(UtilityTest, AnyConvertWrongFields) {
  const ProtobufWkt::Struct obj = MessageUtil::keyValueStruct("test_key", "test_value");
  ProtobufWkt::Any source_any;
...
TEST_F(UtilityTest, JsonConvertSuccess) {
  ProtobufWkt::Duration source_duration;
  source_duration.set_seconds(42);
...
TEST_F(UtilityTest, JsonConvertUnknownFieldSuccess) {
...
TEST_F(UtilityTest, JsonConvertFail) {
  ProtobufWkt::Duration source_duration;
...
TEST_F(UtilityTest, JsonConvertCamelSnake) {
  envoy::config::bootstrap::v2::Bootstrap bootstrap;
...
TEST_F(UtilityTest, YamlLoadFromStringFail) {
  envoy::config::bootstrap::v2::Bootstrap bootstrap;
