...
public:
  ...
  Api::SysCallIntResult bind(int64_t fd) const override { return instance_.bind(fd); }
  Api::SysCallIntResult connect(int64_t fd) const override { return instance_.connect(fd); }
