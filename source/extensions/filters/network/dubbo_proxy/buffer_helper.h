...
public:
  ...
  Api::IoCallUint64Result read(SOCKET_FD, uint64_t) override { NOT_IMPLEMENTED_GCOVR_EXCL_LINE; }
  ...
  Api::IoCallUint64Result write(SOCKET_FD) override { NOT_IMPLEMENTED_GCOVR_EXCL_LINE; }
