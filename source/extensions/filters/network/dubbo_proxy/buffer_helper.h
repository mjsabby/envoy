...
public:
  ...
  Api::SysCallIntResult read(SOCKET_FD, uint64_t) override { NOT_IMPLEMENTED_GCOVR_EXCL_LINE; }
  ...
  Api::SysCallIntResult write(SOCKET_FD) override { NOT_IMPLEMENTED_GCOVR_EXCL_LINE; }
