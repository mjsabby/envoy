...
public:
  ...
  Api::IoCallUint64Result read(SOCKET_HANDLE, uint64_t) override { NOT_IMPLEMENTED_GCOVR_EXCL_LINE; }
  ...
  Api::IoCallUint64Result write(SOCKET_HANDLE) override { NOT_IMPLEMENTED_GCOVR_EXCL_LINE; }
