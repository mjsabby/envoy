...
// This is a workaround for that MSVC expands __VA_ARGS__ after passing them into a macro, rather
// than before passing them into a macro. Without this, _ASSERT_SELECTOR does not work correctly
#define EXPAND(X) X
