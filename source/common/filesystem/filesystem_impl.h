...
public:
  ...
  bool fileExists(absl::string_view path) override;
  bool directoryExists(absl::string_view path) override;
  ssize_t fileSize(absl::string_view path) override;
  std::string fileReadToEnd(absl::string_view path) override;
  bool illegalPath(absl::string_view path) override;
  RawFilePtr createRawFile(absl::string_view path) override;
  std::string canonicalPath(absl::string_view path) override;
};

class RawFileImpl : public RawFile {
public:
  RawFileImpl(absl::string_view path);
  ~RawFileImpl();

  // Filesystem::RawFile
  Api::SysCallIntResult open() override;
