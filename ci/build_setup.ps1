...
# diff here is needed for test_on_windows, see #164309012
$env:BAZEL_TEST_OPTIONS="$env:BAZEL_BUILD_OPTIONS --build_tag_filters=windows_test --test_tag_filters=windows_test --cache_test_results=no --test_output=all $env:BAZEL_EXTRA_TEST_OPTIONS"
