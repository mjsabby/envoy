...
$env:BAZEL_TEST_OPTIONS="$env:BAZEL_BUILD_OPTIONS --build_tag_filters=windows_test --test_tag_filters=windows_test --cache_test_results=no $env:BAZEL_EXTRA_TEST_OPTIONS"
